        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <h5 class="font-white space-xs">ค้นหาร้านอาหาร & สาขาที่ใกล้เคียงกับที่อยู่ของคุณ! </h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">I would like to eat....</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder="ค้นหาอาหารที่คุณอยากทาน"> </div>
                            </div>
                            <button onclick="location.href='restaurants.php'" type="button" class="btn theme-btn btn-lg">ค้นหา</button>
                        </form>
                    </div>
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>เลือกร้านอาหาร</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>สั่งอาหาร</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>จัดส่ง และรอจัดหนัก</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>อาหารที่ผู้คนนิยมสั่งมากที่สุดในเดือนนี้</h2>
                    <p class="lead">ลิ้มลอง เพื่อหารสชาติที่คุณชื่นชอบ</p>
                </div>
                <div class="row">
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															...
															<div class="content">
																...
																<div class="price-btn-block"> <span class="price">$'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">สั่งตอนนี้เลย</a> </div>
															</div>
            ...
            <div class="container">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>เลือกร้านอาหาร</h3>
                                    <p>เลือกร้านอาหารใกล้เคียง กับที่คุณอาศัยอยู่ เพื่อความรวดเร็ว และความสะดวกสบาย</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>เลือกอาหารจานโปรด</h3>
                                <p>ทางเรา มีเมนูแนะนำสุดพิเศษ สำหรับท่านที่ไม่สะดวกมาร้าน ก็สามารถทานได้ โดยการจัดส่งที่มือคุณ</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>ทางเรา ยินดีที่จะจัดส่ง</h3>
                                <p>เตรียมอาหารเสร็จ จะจัดส่งอาหารให้ตามที่คุณต้องการ และให้คุณได้เอร็ดอร่อยไปกับอาหาร</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">ชำระด้วยตนเอง ตอนพนักงานไปส่งอาหาร</p>
                    </div>
                </div>
            </div>
        </section>
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> ขั้นต่ำ ฿ 30.00</div>
																		<div class="mins"><i class="fa fa-motorcycle"></i> 35 min</div>
