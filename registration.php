            ...
            <section class="contact-page inner-page">
               <div class="container">
                  <div class="row">
                                 ...
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input type="text" class="form-control" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email"> <small id="emailHelp" class="form-text text-muted">พวกเราจะเก็บข้อมูลนี้ไว้เป็นความลับ! สบายใจได้</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">เบอร์โทรศัพท์</label>
                                       <input class="form-control" type="text" name="phone" id="example-tel-input-3" placeholder="Phone"> <small class="form-text text-muted">พวกเราจะเก็บข้อมูลนี้ไว้เป็นความลับ! สบายใจได้</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                    ...
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputPassword1">ใส่รหัสผ่านอีกครั้ง</label>
                                       <input type="password" class="form-control" name="cpassword" id="exampleInputPassword2" placeholder="Password"> 
                                    </div>
									 <div class="form-group col-sm-12">
                                       <label for="exampleTextarea">ที่อยู่ในการจัดส่ง</label>
                     ...
                     <!-- WHY? -->
                     <div class="col-md-4">
                        <h4>สมัครได้อย่างรวดเร็ว ง่าย และฟรี</h4>
                        <p>เมื่อลงทะเบียนแล้ว คุณสามารถที่จะสั่งอาหารได้</p>
                        <hr>
                        <img src="images/grab.png" alt="" class="img-fluid">
                        <p></p>
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>ฉันสามารถสั่งอาหารได้อย่างไร ?</a></h4>
                           </div>
                        ...
                        <div class="panel">
                           <div class="panel-heading">
                              <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle" href="#faq2" aria-expanded="true"><i class="ti-info-alt" aria-hidden="true"></i>ฉันสามารถชำระเงินได้อย่างไร ?</a></h4>
                           </div>
                        ...
                        <!-- end:Panel -->
                        <h4 class="m-t-20">ติดต่อฝ่ายบริการเซอร์วิส</h4>
                        <p> เมื่อคุณมองเห็นข้อบกพร่อง และปัญหา ได้โปรด </p>
                        <p> <a href="contact.html" class="btn theme-btn m-t-15">ติดต่อพวกเรา</a> </p>
                     </div>
                     <!-- /WHY? -->
                  </div>
               </div>
